...
/**
 * Get the last error code from library call.
 *
 * @param[in] db See @ref sqldbal_db.
 * @return See @ref sqldbal_status_code.
 */
 ...
 *
 * @param[in]  db     See @ref sqldbal_db.
 * @param[out] errstr String describing previous error. Caller must not
 ...
 * @param[in]  port        Server port number to connect to.
 * @param[in]  username    Username to connect to database.
 * @param[in]  password    Password corresponding to @p username.
 * @param[in]  database    Database name to initially connect to, or NULL
 *                         if no database should get selected initially.
 * @param[in]  flags       See @ref sqldbal_flag.
 * @param[in]  option_list Pass driver-specific parameters to the driver.
 * @param[in]  num_options Number of entries in @p option_list.
 ...
 *
 * The caller can use the returned handle in driver-specific code.
 * Do not free the statement handle directly and instaed use the
...
/**
 * End a transaction started by @ref sqldbal_begin_transaction.
 *
 * @param[in] db See @ref sqldbal_db.
 * @return See @ref sqldbal_status_code.
 */
...
/**
 * Rollback a transaction started by @ref sqldbal_begin_transaction.
 *
 * @param[in] db See @ref sqldbal_db.
 * @return See @ref sqldbal_status_code.
 */
 ...
 *
 * @param[in] db        See @ref sqldbal_db.
 * @param[in] sql       SQL query t execute.
 * @param[in] callback  Function to call for each row returned. The application
 ...
 * @param[in] col_idx Placeholder index referenced in prepared statement.
 * @param[in] s       Text string saved to a SQL text type.
 * @param[in] slen    Length of @p s in bytes if known, or -1 to have
 *                    this function compute the length using strlen().
 * @return See @ref sqldbal_status_code.
 */
enum sqldbal_status_code
 ...
 *                     NULL if they do not need the size.
 * @return See @ref sqldbal_status_code.
 */
enum sqldbal_status_code
